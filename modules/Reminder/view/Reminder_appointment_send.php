	...
	<div class="row" style="min-height: 647px;">
		<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10" id="mainsection">
			...
			<div class="main-area">
				...
				<form class="form" role="form" method="POST" action="modules/Reminder/SendReminder.php" >
				   ...
				   <input type="submit" class="btn btn-primary" name="sendAppointmentButton" id="sendAppointmentButton" value="SEND APPOINTMENT REMINDER" />
